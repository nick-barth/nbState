...
var _nbState = __webpack_require__(1);

var _nbState2 = _interopRequireDefault(_nbState);
...
var state = new _nbState2.default();
...
state.init(initialState, handleStateChange.bind(undefined));
...
var nbState = function () {
	function nbState() {
		_classCallCheck(this, nbState);
	}

	_createClass(nbState, [{
		key: "init",
   ...
   */
		value: function init(initialState, onStateChange) {
   ...
   */
		...
		value: function setState(updates) {
			...
			Object.keys(updates).forEach(function (update) {
				_this.state[update] = updates[update];
			});
